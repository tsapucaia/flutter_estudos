...
mixin _$TodoController on __TodoControlleroList, Store {
  ...
  final _$todosAtom = Atom(name: '__TodoControlleroList.todos');
  ...
  final _$filterAtom = Atom(name: '__TodoControlleroList.filter');
  ...
  final _$currentDescriptionAtom =
      Atom(name: '__TodoControlleroList.currentDescription');
  ...
  final _$__TodoControlleroListActionController =
      ActionController(name: '__TodoControlleroList');

  @override
  void addTodo(String description) {
    final _$actionInfo = _$__TodoControlleroListActionController.startAction();
    try {
      return super.addTodo(description);
    } finally {
      _$__TodoControlleroListActionController.endAction(_$actionInfo);
    }
  }
